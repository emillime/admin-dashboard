...
<div
  class="relative flex flex-col min-w-0 break-words w-full pb-4 shadow-lg rounded bg-white"
>
  <div class="rounded-t mb-0 px-4 py-3 border-0">
    <div class="flex flex-wrap flex-row items-center">
      <h3 class="mr-4 font-semibold text-lg text-slate-700">
        Bokningar ({bookings?.length})
      </h3>
      <button
        class="m-1 text-sky-600 hover:text-sky-900"
      ...
      <tbody>
        {#if bookings}
          ...
          <tr>
            ...
            >
              <span class="font-bold text-slate-600"> Totalt: </span>
              <br />
